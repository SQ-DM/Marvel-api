...
const View = (
  <div className="card m-auto card card text-white bg-dark card border-info">
    ...
    />
    <div className="card-body">
      <h5 className="card-title text-info">Thor</h5>
      <p className="card-text">
        Thor Odinson wields the power of the ancient Asgardians to fight evil
        throughout the Nine Realms and beyond.
      </p>
    </div>
    <div className="card-body">
      <p className="text-info">Comics</p>
      <ul className="list-group list-group-fluid ">
